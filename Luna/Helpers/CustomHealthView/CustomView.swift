...
//       self.titleLabel.textColor = AppColors.themeTextColor
    ...
    public func setUpAttributedString(){
        ...
        let seriesText = (NSAttributedString(string: "\n1.", attributes: [NSAttributedString.Key.foregroundColor:  UIColor(named: "color2")!,NSAttributedString.Key.font: AppFonts.SF_Pro_Display_Medium.withSize(.x14)]))
        ...
        let decText = (NSAttributedString(string: "\n2. Select sources tab and select Luna App", attributes: [NSAttributedString.Key.foregroundColor: UIColor(named: "color2")!,NSAttributedString.Key.font: AppFonts.SF_Pro_Display_Medium.withSize(.x14)]))
        let decText1 = (NSAttributedString(string: "\n3. Set desired permissions", attributes: [NSAttributedString.Key.foregroundColor: UIColor(named: "color2")!,NSAttributedString.Key.font: AppFonts.SF_Pro_Display_Medium.withSize(.x14)]))
