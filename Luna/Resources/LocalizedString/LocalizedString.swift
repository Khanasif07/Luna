...
enum LocalizedString : String {
    ...
    8.3 Notice of Dispute. In the event of a dispute arising under or relating to this Agreement, the disputing party must provide the other party with written notice of the dispute, including the facts giving rise to the dispute and the relief sought by the disputing party. We will provide such notice by email to your email address. You will provide such notice to Luna Health by mail or overnight delivery at the contact address listed on our website. For any dispute subject to arbitration, you and Luna Health will attempt to resolve the dispute through negotiation for 60 days from the date such notice is sent. After 60 days, either party may initiate arbitration if the dispute is not resolved.
    ...
    LUNA HEALTH, INC. PRIVACY STATEMENT
    ...
    For more information on third-party advertising-related cookies and how to opt out of some cookies as you choose, see the descriptions and links below. Click here to visit the Network Advertising Initiative site to set preferences and opt out of third-party targeting cookies.
    ...
    This Privacy Statement was last revised on August 20, 2021.
